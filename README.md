...
项目地址: [https://github.com/XrayRR/XrayR](https://github.com/iSiMX/XrayR)

## 项目目录

* [XrayR](https://github.com/iSiMX/XrayR)：XrayR源码以及软件发布。
* [XrayR-doc](https://github.com/iSiMX/XrayR-doc)：XrayR文档源码。
* [XrayR-script](https://github.com/iSiMX/XrayR-script)：XrayR一键安装脚本以及Docker。
